...
function getArtistByIndex(array, a) {
  return `the artist at index ${array[a].id} is ${array[a].name}`;
}  
...
function addArtist(array){
    array.push({'id': 20,
      'name': 'Dharmik Savaliya', 
      'years': '1996 - june 11',
      'genre': 'Web Design', 
      'nationality': 'American',
      'bio': 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam, laboriosam. Corrupti temporibus reiciendis impedit perspiciatis placeat quos suscipit deleniti quis culpa neque non vero dolore, voluptate molestiae. Consequatur, ad sapiente.'});
      return array;
  }
